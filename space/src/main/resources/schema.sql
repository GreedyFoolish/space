...
(
    ...
    `status`      INT          DEFAULT 0                 NOT NULL COMMENT '状态标志，0 正常 1 删除',
...
(
    ...
    `nav_name`    VARCHAR(255)                       NULL COMMENT '导航名称',
    `nav_url`     VARCHAR(255)                       NULL COMMENT '导航跳转链接',
    `nav_icon`    VARCHAR(255)                       NULL COMMENT '导航图标',
    `nav_sort`    INT UNSIGNED                       NOT NULL DEFAULT 50 COMMENT '导航链接的排序，数据越小排序越靠前',
    `create_by`   BIGINT UNSIGNED                    NULL COMMENT '创建者',
    `update_by`   BIGINT UNSIGNED                    NULL COMMENT '更新者',
    `remark`      VARCHAR(255)                       NULL COMMENT '备注',
    `status`      INT      DEFAULT 0                 NOT NULL COMMENT '状态标志，0 正常 1 删除',
